...
# Define a meta-learner. In this case, we use LogisticRegression,
# but you can experiment with different models.
...
stacking_clf = StackingClassifier(
    ...
    stack_method='auto',  # Use 'predict_proba' if your meta-learner benefits from probabilities
...
# Calculating F1 score
f1 = f1_score(y_test, predictions)
print(f"F1 Score for stacking ensemble: {f1}")
